...
namespace Copyfile
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SharpZip"/> class.
        /// </summary>
        public SharpZip()
        { }
        ...
        /// </returns>
        public static bool UnpackFiles(string file, string dir, string zipPassword = "")
        {
            try
            {
                ...
                if (string.IsNullOrEmpty(zipPassword) == false)
                {
    ...
    public class ClassZip
    {
        ...
        /// 递归压缩文件夹方法
        /// </summary>
        /// <param name="FolderToZip">The folder to zip.</param>
        ...
        ///   <c>true</c> if XXXX, <c>false</c> otherwise.
        /// </returns>
        private static bool ZipFileDictory(string FolderToZip, string ZipedFile, int level, string zipPassword = "")
        {
            bool res;
        ...
        private static bool ZipFile(string FileToZip, string ZipedFile, int level, string zipPassword = "")
        {
        ...
        ///   <c>true</c> if XXXX, <c>false</c> otherwise.
        /// </returns>
        public static bool Zip(String FileToZip, String ZipedFile, int level, string zipPassword = "")
        {
            if (Directory.Exists(FileToZip))
            {
                return ZipFileDictory(FileToZip, ZipedFile, level, zipPassword);
            }
            else if (File.Exists(FileToZip))
            {
                return ZipFile(FileToZip, ZipedFile, level, zipPassword);
            }
            else
            {
                return false;
        ...
        /// <param name="zipPassword">The zip password.</param>
        public static void UnZip(string FileToUpZip, string ZipedFolder, string zipPassword = "")
        {
    ...
    public class ZipHelper
    {
        ...
        Object the_Obj;
        /// <summary>
        /// The the_ information
        /// </summary>
        String the_Info;
        /// <summary>
        /// The the_ start information
        /// </summary>
